...
--gamma 1.25 \
--show-sparse-w-stats \
--checkpoint checkpoints/pretraining/wikitext103/sparseproj2-m.pt \
--distributed \
"
echo "Training ..."
CUDA_VISIBLE_DEVICES='0,1,4' python -m torch.distributed.launch --master_port 1066 --nproc_per_node=3 --use_env train.py $args


echo "Eval ..."
CUDA_VISIBLE_DEVICES='0,1,4' python -m torch.distributed.launch --master_port 1066 --nproc_per_node=3 --use_env train.py $args --resume --full-eval-mode
