...
--mu 0.2 \
--gamma 1.25 \
--checkpoint checkpoints/pretraining/wikitext103/kspectral-eigengate-m.pt \
"
echo "Training ..."
CUDA_VISIBLE_DEVICES='0,1,2,3' python -m torch.distributed.launch --master_port 1234 --nproc_per_node=4 --use_env train.py $args


echo "Eval ..."
CUDA_VISIBLE_DEVICES='0,1,2,3' python -m torch.distributed.launch --master_port 1234 --nproc_per_node=4 --use_env train.py $args --resume --full-eval-mode
