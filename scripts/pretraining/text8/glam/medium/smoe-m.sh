...
--batch-split 2 \
--nbatches 1000 \
--checkpoint checkpoints/pretraining/wikitext-103/glam-m/smoe/smoe-m.pt \
"

echo "Training ..."
CUDA_VISIBLE_DEVICES='0' python -m torch.distributed.launch --master_port 1234 --nproc_per_node=1 --use_env train.py $args
