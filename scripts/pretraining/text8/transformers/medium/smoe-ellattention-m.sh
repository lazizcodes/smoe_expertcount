...
--batch-split 2 \
--nbatches 1000 \
--checkpoint checkpoints/pretraining/text8/ellattention-smoe-m.pt \
--distributed \
"

echo "Training ..."
CUDA_VISIBLE_DEVICES='0,1,2' python -m torch.distributed.launch --master_port 1903 --nproc_per_node=3 --use_env train.py $args --resume
