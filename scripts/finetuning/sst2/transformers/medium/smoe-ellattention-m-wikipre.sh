...
--batch-split 2 \
--nbatches 1000 \
--checkpoint checkpoints/finetuning/sst2/medium/ellattention-smoe-m-wikipre.pt
--pretrained_weight checkpoints/pretraining/wikitext103/smoe-elliptical.pt \
--distributed \
"
