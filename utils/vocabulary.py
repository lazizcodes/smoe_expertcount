...
class Vocab(object):
    ...
    def encode_file(self, path, ordered=False, verbose=False, add_eos=True,
        ...
        # transformation = CompositeTransformation([WordSwapRandomCharacterDeletion(), WordSwapRandomCharacterInsertion(),
        ...
        augmenter = Augmenter(
            ...
            pct_words_to_swap=0.015,
            transformations_per_example=1,
            fast_augment=True
        )
        # augmenter = EasyDataAugmenter(transformations_per_example=1, pct_words_to_swap=0.5)
